        ...
        <div class="container">
            ...
            <div class="form-left">
                <div class="form-wrap">
                    ...
                    <form action="RegisterDAOs" method="post" class="form-input">
                        <div class="form-group">
                            <label for="login-username" class="form-label">Tài khoản</label>
                            <input type="text" id="login-username" name="username" class="btnInput" />
                        </div>
                        <div class="form-group">
                            <label for="login-password" class="form-label">Mật khẩu</label>
                            <input type="password" id="login-password" name="password" class="btnInput" />
                        </div>
                        <div class="form-group">
                            <label for="login-phone" class="form-label">Số điện thoại</label>
                            <input type="text" id="login-phone" name="userPhone" class="btnInput" />
                        </div>
                        <div class="form-group">
                            <label for="login-email" class="form-label"
                                   >Địa chỉ thư điện tử</label
                            >
                            <input type="text" id="login-phone" name="userEmail" class="btnInput" />
                        </div>
                        <div class="role">
